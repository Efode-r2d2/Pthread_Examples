/*
	...
	Desc: this is a simple parallel c program which can calculate the value of pi. This program demonstrate how race condition will occur while 		using pthreads
...
/* thread function vernurable to race condition */
void * Thread_sum(void* rank){
